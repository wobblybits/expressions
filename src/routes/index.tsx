  ...
  return (
    ...
    >
      <div class='flex flex-col items-center justify-center w-full h-full max-w-[90vw] p-12'>
        ...
        <br/><br/>The theory of emotions is a topic I had enjoyed reading about in the past, especially since it sits at the intersection of many different disciplines including cultural anthropology, evolutionary biology, linguistics, health, and philosophy. A few impromptu conversations with fellow recurser <a href="https://www.gagekrause.com/" target="_blank">Gage Krause</a> (who is an awesome coder with an academic background in the philosophy of psychology) helped to germinate the ideas. Special thanks to <a href="https://willems.world/" target="_blank">Willem Pickleman</a> for encouragement to try Three.js for visualizing the results after some earlier 2D prototypes.
      ...
      <div class='max-w-[90vw] m-auto grid grid-cols-1 gap-4 x-sm:grid-cols-1 sm:grid-cols-2 md:grid-cols-3'>
        ...
        <div class='card'>
          <h2><a href="./detect">Emotion Detection</a></h2>
          <div class='content flex flex-col gap-0'>
          <div class="image"><img src="./preview/peach.gif" alt="Pareidolia Webcam Filter" /></div>
          <p>An extension of the pareidolia experiment that is untethered from the emotional expression model. Instead it uses facemesh displacement data directly from a user's webcam. The thin-plate spline calculations were optimized to run in real-time using a GPU.</p>
          </div>
